...
export default function Home() {
  return (
    <div className="relative z-0">
      {" "}
      {/* Keep this z-index lower to avoid overlap issues */}
      {/* Navbar */}
      <Navbar />
      <div
        className="relative w-full bg-cover bg-center flex justify-left items-start"
      ...
      >
        ...
        <div className="text-left text-primary z-10 max-w-screen-xl p-4 lg:py-20 lg:px-32 md:px-24 my-28">
          ...
          <p className="text-lg mt-4 lg:w-4/5 font-semibold">
            With the aid of our technology, Sleepstiq can ensure you that you
      ...
      <div className="relative w-full flex justify-end items-center -mt-12">
        <div className="hidden sm:flex bg-white shadow-lg rounded-lg py-8 px-8 w-10/12 max-w-screen-lg justify-between items-center">
          {/* Use Next.js Image component for the logos */}
          <Image
      ...
      <div className="mx-auto py-16">
        ...
        {/* Visit Our Shop Section */}
        <div className="text-center mt-16">
          <div className="max-w-screen-xl px-4 lg:px-32 md:px-24 py-12 lg:py-24 bg-card shadow-lg rounded-lg mx-auto">
            <h2 className="text-3xl font-bold mb-4">Visit Our Shop</h2>
            <p className="text-secondary mb-8">
              Browse our range of products to find the perfect solution for your
              sleep needs.
            </p>
            <button className="px-12 py-3 bg-btn text-white font-semibold rounded-lg hover:bg-red-600">
              Shop Now
            </button>
          </div>
        </div>
